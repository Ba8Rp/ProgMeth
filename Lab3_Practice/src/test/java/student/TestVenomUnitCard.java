...
public class TestVenomUnitCard {
	...
	@Test
	void testAttack(){
		assertEquals(oppoUnit1.getHealth(), venomUnit1.attackUnit(oppoUnit1));
		oppoUnit1.setHealth(200);
		assertEquals(oppoUnit1.getHealth(), venomUnit2.attackUnit(oppoUnit1));
		oppoUnit1.setHealth(250);
		assertEquals(oppoUnit1.getHealth(), venomUnit3.attackUnit(oppoUnit1));
	}
}
